	...
	*/
	...
	module.exports = {
	    ...
	    Worley: {
	        ...
	        getFeaturePoint: worley.getFeaturePoint
	    },
...
/***/ function(module, exports) {
	...
	function Worley(seed) {
	    ...
	    function insert(arr, value) {
   	    ...
   	    function locateFeaturePoint(input) {
	        var lastRandom,
	            numberFeaturePoints,
	            ...
	            for (var j = -1; j < 2; ++j)
	                for (var k = -1; k < 2; ++k) {
	                    ...
	                    for (var l = 0; l < numberFeaturePoints; ++l) {
	                        ...
	                        insert(distanceArray, featurePoint);
	                    }
	                }

	        return distanceArray.map(function(x) { return x; });
	    }
	    ...
	    function getFeaturePoint(x, y, z) {
	    	return locateFeaturePoint({x:x, y:y, z:z});
	    }
	    ...
	    return {
	        ...
	        Manhattan: Manhattan,
	        setSeed: setSeed,
	        getFeaturePoint: getFeaturePoint
	    }
	}
